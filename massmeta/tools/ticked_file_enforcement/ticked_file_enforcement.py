...
if (scannable_directory == "massmeta/features/") or (scannable_directory == "massmeta/~meta_defines/") or (scannable_directory == "massmeta/reverts/"):
...
with open(file_reference, 'r') as file:
    for line in file:
        ...
        if (scannable_directory == "massmeta/features/") or (scannable_directory == "massmeta/reverts/"):
            module_file_path = line.replace('\\', '/')
            module_file_path_clean = module_file_path[10:-1]
